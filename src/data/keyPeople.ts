  ...
  eqix: [
    {
      ...
      leadershipReasons: {
        strategicJudgement: "新任 CEO，AI 資料中心擴張方向正確但戰略獨立性待表現",
        execution: "REIT 經營執行紀律佳但 AI 訂單 ramp 速度受土地 / 電力限制",
        capitalAllocation: "REIT 結構下 capex 自由度有限，多隨客戶訂單擴張",
        technicalProductInsight: "業務 / SaaS 背景，資料中心工程技術細節仰賴 COO 與運營團隊",
        talentOrganization: "新任，組織整合與留才壓力上升",
        integrityGovernance: "REIT 治理結構標準，無重大爭議",
        resilience: "新任，未經完整景氣循環考驗",
        financialDiscipline: "REIT 高負債結構使紀律有待 ROIC 提升證明",
        communication: "新任 CEO，市場熟悉度仍在建立",
      },
      leadershipConfidence: "Medium",
    },
  ],
  dlr: [
    {
      ...
      leadershipReasons: {
        strategicJudgement: "wholesale AI 押注時點佳但戰略獨立性待表現",
        execution: "AI 資料中心 ramp 紀律佳但時程受電力供應限制",
        capitalAllocation: "REIT 結構下 capex 自由度有限，多隨客戶訂單擴張",
        technicalProductInsight: "財務背景，資料中心工程細節仰賴專業團隊",
        talentOrganization: "公司規模穩定但與 Equinix 高階人才競爭",
        integrityGovernance: "REIT 治理結構標準，無重大爭議",
        customerEcosystem: "hyperscaler 客戶綁定深但 wholesale 模式議價權力受限",
        resilience: "經歷多次資料中心循環尚穩但 AI 浪潮中未經完整考驗",
        financialDiscipline: "REIT 高負債結構使紀律有待 ROIC 提升證明",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "Medium",
  ...
  emr: [
    {
      ...
      name: "Lal Karsanbhai",
      since: 2021,
      leadership: L(4, 4, 4, 4, 4, 5, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "從工業集團聚焦自動化方向正確但 AI 押注時點較被動",
        execution: "BU 整合執行紀律佳但 NI 收購 ramp 速度中等",
        capitalAllocation: "NI 80 億美元收購整合中，ROIC 提升待 2-3 年觀察",
        technicalProductInsight: "業務背景，自動化技術細節仰賴 BU 主管",
        talentOrganization: "公司規模穩定但與 ABB / Rockwell 高階人才競爭",
        customerEcosystem: "工業客戶綁定深但 hyperscaler 直接綁定弱",
        resilience: "經歷多次工業循環尚穩但 NI 整合風險未顯現",
        financialDiscipline: "NI 收購使負債高，去槓桿進度受市場關注",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "Medium",
    },
  ...
  eme: [
    {
      ...
      leadershipReasons: {
        strategicJudgement: "資料中心 / 半導體廠承包押注時點佳但戰略獨立性受市場限制",
        technicalProductInsight: "工程承包業務本質非單一產品，CEO 對細部技術仰賴專案團隊",
        talentOrganization: "公司規模穩定但與 Quanta Services 高階人才競爭",
        communication: "公司低調，法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
    },
  ],
  pwr: [
    {
      ...
      name: "Duke Austin",
      since: 2016,
      bio: "Quanta Services CEO；任內公司股價大漲。",
      leadership: L(4, 5, 4, 4, 4, 5, 5, 5, 5, 4),
      leadershipReasons: {
        strategicJudgement: "電網 / 資料中心承包押注時點佳但戰略獨立性受市場限制",
        capitalAllocation: "多次中型併購紀律穩定但無轉型級交易",
        technicalProductInsight: "業務背景，工程細節仰賴專案團隊",
        talentOrganization: "公司規模快速擴張下留才壓力上升",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
    },
  ...
  mtz: [
    {
      ...
      leadership: L(4, 4, 4, 3, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "電網 / 通信承包押注穩定但 AI 資料中心切入較被動",
        execution: "BU 整合執行紀律佳但毛利率受競爭壓力",
        capitalAllocation: "家族企業文化下，資本配置紀律佳但無轉型級交易",
        technicalProductInsight: "業務 / 家族背景，技術細節仰賴專案經理",
        talentOrganization: "家族企業文化下，外部高階人才吸引力受限",
        integrityGovernance: "家族控股結構使治理透明度中等",
        customerEcosystem: "電力 / 通信客戶綁定深但 hyperscaler 直接綁定弱",
        resilience: "經歷多次工程循環尚穩但 AI 浪潮中差異化挑戰",
        financialDiscipline: "毛利率受承包競爭壓力，紀律佳但結構性限制",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "Medium",
    },
  ...
  gev: [
    {
      ...
      name: "Scott Strazik",
      since: 2024,
      bio: "GE Vernova 分拆後首任 CEO；前 GE 電力 CEO。",
      leadership: L(5, 4, 4, 5, 4, 4, 5, 4, 4, 4),
      leadershipReasons: {
        execution: "新分拆公司，BU 整合與 ramp 紀律佳但待 1-2 年驗證",
        capitalAllocation: "分拆後新公司，capex 策略仍在建立；無大型併購足跡",
        talentOrganization: "公司分拆後留才壓力上升",
        integrityGovernance: "新上市公司，治理結構建立中",
        resilience: "新公司，未經完整景氣循環考驗",
        financialDiscipline: "新公司毛利率與紀律待 ROIC 提升證明",
        communication: "新任、新公司，市場熟悉度仍在建立",
      },
      leadershipConfidence: "High",
    },
  ],
  abb: [
    {
      ...
      name: "Morten Wierod",
      since: 2024,
      bio: "ABB 內部出身，2024 接任 CEO。",
      leadership: L(4, 4, 4, 4, 4, 5, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "電氣化 / 自動化方向正確但 AI 押注時點較被動",
        execution: "BU 整合執行紀律佳但 ramp 速度受市場限制",
        capitalAllocation: "現金充裕但無大型併購；資金多以股票回購與股息回饋",
        technicalProductInsight: "工程背景但近年自動化 AI 技術前瞻仰賴 R&D",
        talentOrganization: "公司規模穩定但與 Schneider / Eaton 高階人才競爭",
        customerEcosystem: "工業客戶綁定深但 hyperscaler 直接綁定弱",
        resilience: "新任，未經完整循環考驗",
        financialDiscipline: "毛利率穩定但受工業景氣影響波動",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "Medium",
    },
  ...
  hubb: [
    {
      ...
      leadership: L(4, 4, 4, 3, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "電力產品聚焦穩定但 AI 資料中心押注較被動",
        execution: "BU 整合執行紀律佳但 ramp 速度受競爭限制",
        capitalAllocation: "中型併購紀律穩定但無轉型級交易",
        technicalProductInsight: "電力產品線分散，CEO 對單一技術深度仰賴部門主管",
        talentOrganization: "公司規模穩定但與 Eaton / ABB 高階人才競爭",
        integrityGovernance: "上市公司治理結構標準，無重大爭議",
        customerEcosystem: "電力 / 工業客戶綁定深但 hyperscaler 直接綁定弱",
        resilience: "經歷多次景氣循環尚穩但 AI 浪潮中差異化挑戰",
        financialDiscipline: "毛利率穩定但受競爭壓力波動",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "Medium",
    },
  ...
  cat: [
    {
      ...
      name: "Jim Umpleby",
      since: 2017,
      bio: "Caterpillar 內部出身 30+ 年；資本配置紀律佳。",
      leadership: L(4, 5, 5, 4, 4, 5, 4, 5, 5, 4),
      leadershipReasons: {
        strategicJudgement: "建築 / 礦業設備聚焦穩定但 AI 資料中心電力機組押注較被動",
        technicalProductInsight: "業務背景，機械工程細節仰賴 BU 主管",
        talentOrganization: "公司規模穩定但與 Cummins / Komatsu 高階人才競爭",
        customerEcosystem: "工業 / 建築客戶綁定深但 hyperscaler 直接綁定弱",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
    },
  ...
  cmi: [
    {
      ...
      since: 2022,
      bio: "Cummins 工程背景 CEO；任內加強氫能策略。",
      leadership: L(4, 4, 4, 5, 4, 5, 4, 5, 4, 4),
      leadershipReasons: {
        strategicJudgement: "氫能 / 替代燃料押注時點佳但 ROIC 提升尚待 2-3 年驗證",
        execution: "Meritor 收購整合執行進度可但氫能 ramp 速度中等",
        capitalAllocation: "Meritor 收購使負債高，去槓桿進度受市場關注",
        talentOrganization: "公司規模穩定但與 Caterpillar 高階人才競爭",
        customerEcosystem: "傳統商用車客戶綁定深但氫能客戶生態系仍在建立",
        financialDiscipline: "氫能 R&D 投入使短期毛利率承壓",
        communication: "工程背景，公開風格務實但市場期望管理仍在建立",
      },
      leadershipConfidence: "Medium",
    },
  ],
  gnrc: [
    {
      ...
      leadership: L(4, 4, 4, 3, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "居家發電機聚焦穩定但 AI 資料中心切入較被動",
        execution: "BU 整合執行紀律佳但 ramp 速度受供應鏈限制",
        capitalAllocation: "多次中型併購紀律穩定但無轉型級交易",
        technicalProductInsight: "業務背景，發電機機械工程細節仰賴工程主管",
        talentOrganization: "公司規模穩定但與 Caterpillar 高階人才競爭",
        integrityGovernance: "上市公司治理結構標準，無重大爭議",
        customerEcosystem: "居家 / 商用客戶綁定深但 hyperscaler 直接綁定弱",
        resilience: "經歷多次景氣循環尚穩但與颶風季節綁定波動大",
        financialDiscipline: "毛利率穩定但訂單能見度受天氣 / 政策影響",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "Medium",
    },
  ...
  rok: [
    {
      ...
      leadership: L(4, 4, 4, 4, 4, 5, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "自動化軟體 / 雲端轉型方向正確但 ramp 速度落後 Siemens / ABB",
        execution: "BU 整合執行紀律佳但毛利率受競爭壓力",
        capitalAllocation: "多次中型併購紀律穩定但無轉型級交易",
        technicalProductInsight: "業務背景，自動化技術細節仰賴 BU 主管",
        talentOrganization: "公司規模穩定但與 Siemens 高階人才競爭",
        customerEcosystem: "工業客戶綁定深但 hyperscaler 直接綁定弱",
        resilience: "經歷多次景氣循環尚穩但 AI 浪潮中差異化挑戰",
        financialDiscipline: "毛利率穩定但受工業景氣影響波動",
        communication: "法說會風格務實但前瞻指引保守",
  ...
  flnc: [
    {
      ...
      leadershipReasons: {
        ...
        technicalProductInsight: "業務背景，儲能技術細節仰賴 R&D 主管",
        talentOrganization: "合資結構下高階人才異動頻繁",
        integrityGovernance: "合資結構治理透明度中等",
  ...
  cien: [
    {
      ...
      name: "Gary Smith",
      since: 2001,
      bio: "Ciena CEO 超過 20 年；coherent 光通訊技術領先。",
      leadership: L(4, 4, 4, 5, 4, 5, 4, 5, 4, 4),
      leadershipReasons: {
        strategicJudgement: "coherent 光通訊聚焦穩定但 AI 資料中心押注時點較被動",
        execution: "BU 整合執行紀律佳但 ramp 速度受電信客戶 capex 影響",
        capitalAllocation: "現金累積但無大型併購；資金多用於 R&D 與股票回購",
        talentOrganization: "公司規模穩定但與 Cisco / Juniper 高階人才競爭",
        customerEcosystem: "電信客戶綁定深但 hyperscaler 直接綁定中等",
        financialDiscipline: "毛利率穩定但訂單能見度受電信 capex 循環影響",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
    },
  ...
  net: [
    {
      ...
      leadershipReasons: {
        execution: "產品 ramp 紀律佳但 AI Workers 等新平台 ramp 速度待證明",
        capitalAllocation: "現金充裕但無大型併購；資金多投入 R&D 與 AI 基建",
        talentOrganization: "公司高速擴張下留才壓力上升",
        resilience: "公司歷史不長，未經完整景氣循環考驗",
  ...
  adi: [
    {
      ...
      name: "Vincent Roche",
      since: 2013,
      bio: "Analog Devices 長期 CEO；併購 Maxim 後鞏固類比霸主。",
      leadership: L(4, 4, 4, 5, 4, 5, 4, 5, 5, 4),
      leadershipReasons: {
        strategicJudgement: "類比 IC 聚焦穩定但 AI 押注時點較被動",
        execution: "Maxim 整合執行紀律佳但 ramp 速度受車用景氣影響",
        capitalAllocation: "Maxim 209 億美元收購為大型交易，整合與綜效已顯現但仍有提升空間",
        talentOrganization: "公司規模穩定但與 TI / NXP 高階人才競爭",
        customerEcosystem: "車用 / 工業客戶綁定深但 hyperscaler 直接綁定弱",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
  ...
  stm: [
    {
      ...
      leadership: L(4, 4, 4, 4, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "車用 / MCU 聚焦穩定但 AI 押注時點較被動",
        execution: "BU 整合執行紀律佳但毛利率受車用景氣下行壓力",
        capitalAllocation: "12 吋 capex 龐大，ROIC 提升待 2-3 年驗證",
        technicalProductInsight: "工程背景紮實但業務面前瞻押注仰賴 BU 主管",
        talentOrganization: "公司規模穩定但與 NXP / Infineon 高階人才競爭",
        integrityGovernance: "法義雙國政府持股使治理結構複雜",
        customerEcosystem: "車用客戶綁定深但 hyperscaler 直接綁定弱",
        resilience: "經歷多次半導體循環尚穩但車用下行週期壓力大",
        financialDiscipline: "毛利率受車用景氣影響波動",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
    },
  ...
  amba: [
    {
      ...
      leadershipReasons: {
        strategicJudgement: "從安防轉型車載 ADAS 方向正確但 ramp 速度遠慢於預期",
        execution: "車載產品 ramp 多次延後，執行可預測性中等",
  ...
  form: [
    {
      ...
      leadership: L(4, 4, 4, 5, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "探針卡聚焦穩定但戰略獨立性受設備循環限制",
        execution: "BU 整合執行紀律佳但 ramp 受 HBM / AI 訂單時程影響",
        capitalAllocation: "公司規模中等，capex 受設備循環影響，無大型併購紀錄",
        talentOrganization: "公司規模穩定但與大廠高階人才競爭",
        integrityGovernance: "上市公司治理結構標準，無重大爭議",
        customerEcosystem: "客戶集中於記憶體 / 邏輯廠，hyperscaler 直接綁定弱",
        resilience: "經歷多次半導體循環尚穩但訂單能見度受 capex 影響",
        financialDiscipline: "毛利率穩定但受設備循環影響波動",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "Medium",
    },
  ...
  ter: [
    {
      ...
      leadership: L(4, 4, 4, 4, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "新任，戰略獨立判斷尚待表現",
        execution: "新任，執行紀錄待累積",
        capitalAllocation: "新任，重大資本配置決策尚未發生",
        technicalProductInsight: "工程背景紮實但業務面前瞻押注仰賴 BU 主管",
        talentOrganization: "新任，組織整合與留才壓力上升",
        integrityGovernance: "上市公司治理結構標準，無重大爭議",
        customerEcosystem: "新任，與大客戶直接關係待建立",
  ...
  klic: [
    {
      ...
      leadership: L(4, 4, 3, 4, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "封裝設備聚焦穩定但 AI / 先進封裝押注時點較被動",
        execution: "BU 整合執行紀律佳但 ramp 速度受設備循環影響",
        capitalAllocation: "公司規模中等，capex 受設備循環影響，無大型併購紀錄",
        technicalProductInsight: "工程背景紮實但業務面前瞻押注仰賴 BU 主管",
        talentOrganization: "公司規模穩定但與大廠高階人才競爭",
        integrityGovernance: "上市公司治理結構標準，無重大爭議",
        customerEcosystem: "客戶集中於 OSAT，hyperscaler 直接綁定弱",
        resilience: "經歷多次景氣循環尚穩但訂單能見度受 capex 影響",
        financialDiscipline: "毛利率穩定但受設備循環影響波動",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "Medium",
  ...
  glw: [
    {
      ...
      name: "Wendell Weeks",
      since: 2005,
      bio: "Corning CEO 20 年；長期 R&D 投資文化。",
      leadership: L(5, 4, 4, 5, 5, 5, 5, 5, 4, 4),
      leadershipReasons: {
        execution: "Gorilla Glass / 光纖 ramp 紀律佳但部分新領域（汽車內飾玻璃）成效中等",
        capitalAllocation: "Samsung Display 持股交叉複雜；多次資產交換但無轉型級交易",
        financialDiscipline: "R&D 比重高使短期毛利率承壓，紀律佳但週期波動大",
        communication: "創辦級長期 CEO 但對外公開風格保守，前瞻指引仰賴 CFO 與 IR",
      },
      leadershipConfidence: "High",
    },
  ],
  ...
  snow: [
    {
      ...
      leadershipReasons: {
        strategicJudgement: "AI 平台（Cortex）押注時點佳但戰略獨立性待表現",
        execution: "新任 CEO，Cortex ramp 進度尚待證明",
        capitalAllocation: "公司估值高（PS > 15），股票回購 + 收購並行；資本紀律待證明",
        technicalProductInsight: "前 Google 廣告背景，data warehouse 技術細節仰賴 R&D",
        talentOrganization: "新任，組織重整與留才壓力上升",
        integrityGovernance: "上市公司治理結構標準，無重大爭議",
        customerEcosystem: "大客戶綁定深但與 Databricks / hyperscaler 競爭加劇",
        resilience: "新任，未經完整景氣循環考驗",
  ...
  mdb: [
    {
      ...
      leadership: L(4, 4, 3, 4, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "Atlas 雲端轉型方向正確但 AI / vector DB 押注時點較被動",
        execution: "Atlas ramp 紀律佳但毛利率受競爭壓力",
        capitalAllocation: "公司規模中等，無大型併購；資本多投入 R&D 與業務擴張",
        technicalProductInsight: "業務背景，資料庫技術細節仰賴 CTO",
        talentOrganization: "公司規模穩定但與 Databricks / Snowflake 高階人才競爭",
        integrityGovernance: "上市公司治理結構標準，無重大爭議",
        customerEcosystem: "開發者社群綁定深但 hyperscaler 競爭加劇",
        resilience: "經歷多次科技循環尚穩但 AI 浪潮中差異化挑戰",
        financialDiscipline: "成長為先模式下 GAAP 仍虧損，紀律相對寬鬆",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
    },
  ...
  ddog: [
    {
      ...
      name: "Olivier Pomel",
      since: 2010,
      bio: "Datadog 共同創辦人；以開發者導向設計建立 observability 平台。",
      leadership: L(4, 5, 4, 5, 4, 5, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "observability 平台戰略漂亮但 AI 押注時點較被動",
        capitalAllocation: "現金充裕但無大型併購；資本多投入 R&D 與業務擴張",
        talentOrganization: "公司高速擴張下留才壓力上升",
        customerEcosystem: "開發者綁定深但與 New Relic / Splunk 拉鋸",
        resilience: "公司歷史較短，未經完整景氣循環考驗",
        financialDiscipline: "毛利率穩定但成長為先模式使紀律相對寬鬆",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
    },
  ...
  pltr: [
    {
      ...
      leadershipReasons: {
        execution: "AIP 訂單 ramp 漂亮但商業客戶銷售週期長",
        capitalAllocation: "現金充裕但無大型併購；資本多用於 R&D 與股票回購",
        talentOrganization: "創辦人風格強烈，高階人才依附他個人決策",
        integrityGovernance: "雙重股權結構讓創辦人擁有過大控制權；對國防業務多次發表爭議性公開言論",
        financialDiscipline: "高估值（PE > 200）下毛利率與成長預期需持續驗證；員工股票薪酬比重高",
        communication: "公開風格直率甚至挑釁，發言常引發爭議",
      },
      leadershipConfidence: "High",
    },
  ],
  ...
  crwd: [
    {
      ...
      leadershipReasons: {
        execution: "AI EDR 戰略漂亮但 2024 全球 outage 是執行重大瑕疵",
        capitalAllocation: "現金充裕但無大型併購；資本多用於 R&D 與股票回購",
        talentOrganization: "公司高速擴張下留才壓力上升，outage 後組織重整",
        integrityGovernance: "2024 全球 outage 影響 850 萬台 Windows、引發航空 / 醫療 / 金融大規模中斷",
        customerEcosystem: "客戶綁定深但 outage 後信任修復是觀察重點",
        resilience: "outage 後客戶流失與訴訟壓力，韌性受考驗",
        financialDiscipline: "毛利率穩定但 outage 賠償使短期紀律承壓",
  ...
  panw: [
    {
      ...
      name: "Nikesh Arora",
      since: 2018,
      bio: "前 Google + SoftBank 主管，加入 Palo Alto 後主導平台化轉型。",
      leadership: L(5, 5, 5, 4, 5, 4, 5, 4, 5, 5),
      leadershipReasons: {
        technicalProductInsight: "Google 業務 / SoftBank 投資背景，技術細節仰賴 CTO",
        integrityGovernance: "高薪酬爭議與 Platformization 議價策略受部分客戶質疑",
        resilience: "經歷多次科技循環尚穩但 AI 競爭壓力下未經完整考驗",
      },
      leadershipConfidence: "High",
    },
  ],
  zs: [
    {
      ...
      leadershipReasons: {
        execution: "Zero Trust ramp 紀律佳但毛利率受競爭壓力",
        capitalAllocation: "現金累積但無大型併購；資本多投入 R&D 與業務擴張",
        talentOrganization: "創辦人風格使高階人才依附他個人決策",
        integrityGovernance: "雙重股權結構使創辦人控制權集中",
        customerEcosystem: "Zero Trust 客戶綁定深但與 Palo Alto / CrowdStrike 競爭加劇",
        resilience: "公司歷史較短，未經完整景氣循環考驗",
  ...
  okta: [
    {
      ...
      leadership: L(4, 4, 3, 4, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "Identity 平台聚焦穩定但 AI 押注時點較被動",
        execution: "Auth0 整合執行進度可但 2022-2023 多次安全事件使執行紀律受質疑",
        capitalAllocation: "Auth0 65 億美元收購整合後仍未充分綜效，資本配置成效一般",
        technicalProductInsight: "工程背景紮實但 AI 整合前瞻仰賴 CTO",
        talentOrganization: "公司規模穩定但與 Microsoft Entra 高階人才競爭",
        integrityGovernance: "2022-2023 多次安全事件（Lapsus / GitHub 洩漏）使治理受質疑",
        customerEcosystem: "企業客戶綁定深但 Microsoft Entra 競爭加劇",
        resilience: "經歷多次安全事件後仍維持成長，韌性中等",
        financialDiscipline: "毛利率穩定但 GAAP 仍接近損益兩平",
        communication: "法說會風格務實但前瞻指引保守",
      },
      leadershipConfidence: "High",
    },
  ...
  cybr: [
    {
      ...
      leadership: L(4, 4, 3, 4, 4, 4, 4, 4, 4, 4),
      leadershipReasons: {
        strategicJudgement: "PAM 聚焦穩定但 AI 押注時點較被動",
        execution: "Venafi 整合執行進度可但 ramp 速度受市場限制",
        capitalAllocation: "Venafi 15 億美元收購整合進度待觀察",
        technicalProductInsight: "業務背景，技術細節仰賴 CTO",
        talentOrganization: "公司規模穩定但與大型網安廠高階人才競爭",
        integrityGovernance: "上市公司治理結構標準，無重大爭議",
        customerEcosystem: "PAM 客戶綁定深但 hyperscaler 直接綁定弱",
        resilience: "經歷多次景氣循環尚穩但 AI 浪潮中差異化挑戰",
        financialDiscipline: "毛利率穩定但訂閱轉型使短期現金流承壓",
        communication: "法說會風格務實但前瞻指引保守",
      },
  ...
  tsla: [
    {
      ...
      leadershipReasons: {
        ...
        talentOrganization: "強人風格使高階人才依附他個人決策；多次高調裁員引發組織不穩",
        integrityGovernance: "2018 「funding secured」案被 SEC 罰款 + 強制 tweet 預審；公司治理被多次股東訴訟挑戰",
        customerEcosystem: "Tesla 車主社群忠誠度高但近年政治發言使品牌受部分客群反彈",
  ...
  sym: [
    {
      ...
      leadershipReasons: {
        strategicJudgement: "倉儲自動化戰略漂亮但 ramp 速度依賴單一大客戶（Walmart）",
        execution: "Walmart 訂單 ramp 紀律可但多次時程調整",
        capitalAllocation: "C&S 既是 CEO 創辦的公司也是主要客戶，存在關聯人交易疑慮",
        technicalProductInsight: "業務背景，自動化技術細節仰賴 R&D 主管",
        talentOrganization: "公司高速擴張下留才壓力上升",
        integrityGovernance: "C&S 關聯人交易結構使治理透明度受質疑",
        customerEcosystem: "Walmart 大單綁定深但客戶集中度高",
        resilience: "公司歷史短，未經完整景氣循環考驗",
